...
<div class="row">
    ...
    <div class="col-sm-4"  align="center">
        ...
        <div class="col-12 text-center">
            <div class="display-5"><i class="fa fa-futbol-o text-primary" aria-hidden="true"> 2ª Rodada</i></div>
        </div>
        
        <!--FORMULÁRIO_RODADA_2-->
            <form action="RodadaControlador" method="POST"> 
                
                <c:forEach var="lista" items="${listaJogos_r2}" varStatus="index">
                    <div class="col-11">
    ...
    <div class="col-sm-8">
        ...
        <c:forEach var="lista" items="${listaJogos_total}" varStatus="index">
            <input type="text" name="timeA${lista.soma}" value="${lista.soma}">
        </c:forEach>

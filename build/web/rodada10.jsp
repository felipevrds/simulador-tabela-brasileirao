...
<div class="row">
    ...
    <div class="col-sm-4"  align="center">
        ...
        <div class="col-12 text-center">
            <div class="display-5"><i class="fa fa-futbol-o text-primary" aria-hidden="true"> 10ª Rodada</i></div>
        </div>
        
        <!--FORMULÁRIO_RODADA_10-->
            <form action="RodadaControlador" method="POST"> 
                
                <c:forEach var="lista" items="${listaJogos_r10}" varStatus="index">
                    <div class="col-11">
